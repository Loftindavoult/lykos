...
// independent of which core level a client is on. Inventory is a flat $30/mo
// on top of any package; seats are already covered by the package's per-user
// fee, so no per-user charge here.
export const INVENTORY_ADDON = { label: "Inventory & Cash Flow add-on", base: 30, perUser: 0 };
